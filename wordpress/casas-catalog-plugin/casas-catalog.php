...
function display_product_catalog() {
    ...
    if ($casasList)
    {
        ...
        foreach ($casasList as $product)
        {
            ...
            $output .= '<img class="object-cover w-full h-64" src="https://tailwindcss.com/_next/static/media/responsive-1.fd2e9248.png" alt="Imagen" />';
    ...
    else
    {
        ...
        $output .= '<h2> Sin datos disponibles</h2>';
    }
