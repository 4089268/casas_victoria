...
<template>
    ...
    <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
        <div class="relative flex flex-col justify-center w-full h-screen dark:bg-gray-900 sm:p-0 lg:flex-row">
            ...
            <div class="hidden lg:flex items-center justify-center w-1/2 bg-[#4e647c] dark:bg-gray-700 p-10 text-center">
                <div class="max-w-sm">
                    <a href="#" target="_blank" class="block mb-4">
                        <AuthenticationCardLogo class="mx-auto" />
                    </a>
                    <h2 class="text-2xl text-gray-300 dark:text-gray-100 font-semibold">
                        Administrador Casas Garcia
                    </h2>
                </div>
            </div>
        </div>
